    ...
    : m_pDataBus(InDataBus)
{
    ...
    m_InstructionTable =
    {
        ...
        { BPL_Relative,  &Cpu::BPL }, { ORA_IndirectY, &Cpu::ORA }, { OP_NotImplemented, &Cpu::INV }, { SLO_IndirectY,     &Cpu::SLO }, { NOP_ZeroPageX, &Cpu::NOP }, { ORA_ZeroPageX, &Cpu::ORA }, { ASL_ZeroPageX, &Cpu::ASL }, { SLO_ZeroPageX, &Cpu::SLO }, { CLC_Implied, &Cpu::CLC }, { ORA_AbsoluteY, &Cpu::ORA }, { UNOP_Implied,    &Cpu::NOP }, { SLO_AbsoluteY,     &Cpu::SLO }, { NOP_AbsoluteX, &Cpu::NOP }, { ORA_AbsoluteX, &Cpu::ORA }, { ASL_AbsoluteX,     &Cpu::ASL }, { SLO_AbsoluteX,     &Cpu::SLO },
        ...
        { BMI_Relative,  &Cpu::BMI }, { AND_IndirectY, &Cpu::AND }, { OP_NotImplemented, &Cpu::INV }, { RLA_IndirectY,     &Cpu::RLA }, { NOP_ZeroPageX, &Cpu::NOP }, { AND_ZeroPageX, &Cpu::AND }, { ROL_ZeroPageX, &Cpu::ROL }, { RLA_ZeroPageX, &Cpu::RLA }, { SEC_Implied, &Cpu::SEC }, { AND_AbsoluteY, &Cpu::AND }, { UNOP_Implied,    &Cpu::NOP }, { RLA_AbsoluteY,     &Cpu::RLA }, { NOP_AbsoluteX, &Cpu::NOP }, { AND_AbsoluteX, &Cpu::AND }, { ROL_AbsoluteX,     &Cpu::ROL }, { RLA_AbsoluteX,     &Cpu::RLA },
        ...
        { BNE_Relative,  &Cpu::BNE }, { CMP_IndirectY, &Cpu::CMP }, { OP_NotImplemented, &Cpu::INV }, { DCP_IndirectY,     &Cpu::DCP }, { NOP_ZeroPageX, &Cpu::NOP }, { CMP_ZeroPageX, &Cpu::CMP }, { DEC_ZeroPageX, &Cpu::DEC }, { DCP_ZeroPageX, &Cpu::DCP }, { CLD_Implied, &Cpu::CLD }, { CMP_AbsoluteY, &Cpu::CMP }, { UNOP_Implied,    &Cpu::NOP }, { DCP_AbsoluteY,     &Cpu::DCP }, { NOP_AbsoluteX, &Cpu::NOP }, { CMP_AbsoluteX, &Cpu::CMP }, { DEC_AbsoluteX,     &Cpu::DEC }, { DCP_AbsoluteX,     &Cpu::DCP },
        { CPX_Immediate, &Cpu::CPX }, { SBC_IndirectX, &Cpu::SBC }, { NOP_Immediate,     &Cpu::NOP }, { ISB_IndirectX,     &Cpu::ISB }, { CPX_ZeroPage,  &Cpu::CPX }, { SBC_ZeroPage,  &Cpu::SBC }, { INC_ZeroPage,  &Cpu::INC }, { ISB_ZeroPage,  &Cpu::ISB }, { INX_Implied, &Cpu::INX }, { SBC_Immediate, &Cpu::SBC }, { NOP_Implied,     &Cpu::NOP }, { USBC_Immediate,    &Cpu::SBC }, { CPX_Absolute,  &Cpu::CPX }, { SBC_Absolute,  &Cpu::SBC }, { INC_Absolute,      &Cpu::INC }, { ISB_Absolute,      &Cpu::ISB },
        { BEQ_Relative,  &Cpu::BEQ }, { SBC_IndirectY, &Cpu::SBC }, { OP_NotImplemented, &Cpu::INV }, { ISB_IndirectY,     &Cpu::ISB }, { NOP_ZeroPageX, &Cpu::NOP }, { SBC_ZeroPageX, &Cpu::SBC }, { INC_ZeroPageX, &Cpu::INC }, { ISB_ZeroPageX, &Cpu::ISB }, { SED_Implied, &Cpu::SED }, { SBC_AbsoluteY, &Cpu::SBC }, { UNOP_Implied,    &Cpu::NOP }, { ISB_AbsoluteY,     &Cpu::ISB }, { NOP_AbsoluteX, &Cpu::NOP }, { SBC_AbsoluteX, &Cpu::SBC }, { INC_AbsoluteX,     &Cpu::INC }, { ISB_AbsoluteX,     &Cpu::ISB }
    };
}
